...
<%--<body>--%>
<%--<div  align="center">--%>
	<%--&lt;%&ndash;<a>基于Bean方式的控制:</a>&ndash;%&gt;--%>
	<%--&lt;%&ndash;<br>没注册的用户，请<a  href="${pageContext.request.contextPath }/register">注册</a>！&ndash;%&gt;--%>
	<%--&lt;%&ndash;<br>已注册的用户，去<a href="${pageContext.request.contextPath }/login">登录</a>！&ndash;%&gt;--%>
	<%--&lt;%&ndash;<br>&ndash;%&gt;--%>
	<%--&lt;%&ndash;<a>------------------</a>&ndash;%&gt;--%>
	<%--&lt;%&ndash;<br><a>基于注解方式的控制:</a>&ndash;%&gt;--%>
	<%--&lt;%&ndash;<br>没注册的用户，请<a href="${pageContext.request.contextPath }/index/register">注册</a>！&ndash;%&gt;--%>
	<%--&lt;%&ndash;<br>已注册的用户，去<a href="${pageContext.request.contextPath }/index/login">登录</a>！&ndash;%&gt;--%>
<%--</div>--%>
<%--</body>--%>
<%--</html>--%>
...
<head>
	...
	<%--<link rel="stylesheet" href="${pageContext.request.contextPath}//res.layui.com/layui/dist/css/layui.css"  media="all">--%>
</head>
<body>
<a href="WEB-INF/jsp/admin/orderManager.jsp">haha</a>
